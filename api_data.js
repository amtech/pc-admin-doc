define({ "api": [
  ...
  {
    "type": "get",
    "url": "/api/customers/delegation",
    "title": "[半]全委客户列表",
    "name": "DelegationCustomers",
    "group": "Customer",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/delegation/fee_detail",
    "title": "费用/计提明细",
    "name": "DelegationFeeDetail",
    "group": "Delegation",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>费用fee/计提withdraw</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
    ...
    "success": {
      "examples": [
        {
          "title": "费用:",
          "content": "{\n    records: [{\n        \"start_time\": \"2017-10-11\",\n        \"end_time\": \"2017-11-11\",\n        \"persistent_amount\": 100.01,    # 存续金额\n        \"management\": 888,  # 管理费\n        \"details\": [{\n            \"product_name\": \"麦策1号\",\n            \"persistent_amount\": 100.01,    # 存续金额\n            \"management_rate\": 0.1, # 管理费率\n            \"management\": 888,  # 管理费\n            \"risk_effect\": true # 风险影响\n        }]\n    }]\n}",
          "type": "json"
        },
        {
          "title": "计提:",
          "content": "{\n    \"profit_rate\": 8.13,    # 收益率\n    records: [{\n        \"start_time\": \"2017-10-11\",\n        \"end_time\": \"2017-11-11\",\n        \"persistent_amount\": 100.01,    # 存续金额\n        \"profit\": 12.3  # 收益\n        \"profit_rate\": 2.13,    # 收益率(年化)\n        \"absolute_profit_rate\": 3.31,   # 绝对收益率\n        \"performance\": 3123, # 业绩提成，\n        \"details\": [{\n            \"product_name\": \"麦策1号\",\n            \"persistent_amount\": 100.01,    # 存续金额\n            \"profit\": 12.3,  # 收益\n            \"calc\": \"计算方法\",\n            \"risk_effect\": true # 风险影响\n        }]\n    }]\n}",
          "type": "json"
        }
      ]
    },
    "filename": "admin/frontend/delegation.py",
    "groupTitle": "Delegation"
  },
  {
    "type": "get",
    "url": "/api/delegation/fee",
    "title": "费用/计提",
    "name": "DelegationFeeSummary",
    "group": "Delegation",
    "version": "1.0.0",
    "parameter": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/api/delegation/time_slot",
    "title": "时间段",
    "name": "DelegationTimeSlot",
    "group": "Delegation",
    "version": "1.0.0",
    "parameter": {
      "fields": {
    ...
    "success": {
      "examples": [
        {
          "title": "费用{年份+季度}:",
          "content": "[201904,201903,201902]",
          "type": "json"
        },
        {
          "title": "计提{年份}:",
          "content": "[2019,2018,2017]",
          "type": "json"
        }
      ]
    },
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "order_by_direction",
            "description": "<p>排序顺序: normal 倒序, asc 正序</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "patch",
    "url": "/api/orders/:order_no/order_type",
    "title": "修改订单类型",
  ...
  {
    "type": "post",
    "url": "/api/products/:pid/accumulation_values",
    "title": "创建产品累计净值",
    "name": "CreateProductAccumulationValues",
    "group": "Product",
    "version": "1.0.0",
    "parameter": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/api/products/{产品ID}/latest_value",
    "title": "获取浮动产品最新净值信息",
    "name": "GetProductLatestValue",
    "group": "Product",
    "version": "1.0.0",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "{\n    \"date\": \"2017-12-16T16:00:00\",  // 最新净值日\n    \"value\": 1,      // 最新净值\n    \"accumulation_value\": 3        // 累计净值\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "url": "/api/products/:pid/accumulation_values",
    "title": "产品累计净值列表",
    "name": "ProductAccumulationValues",
    "group": "Product",
    "version": "1.0.0",
    "success": {
      "examples": [
  ...
  {
    "type": "get",
    "url": "/api/products/:pid/accumulation_value_graph",
    "title": "产品累计净值图",
    "name": "ProductAccumulationValuesGraph",
    "group": "Product",
    "version": "1.0.0",
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "title": "删除产品累计净值",
    "name": "deleteProductAccumulationValues",
    "group": "Product",
    "version": "1.0.0",
    "filename": "admin/frontend/product.py",
    "groupTitle": "Product"
  ...
  {
    "type": "put",
    "url": "/api/products/:pid/accumulation_values/:id",
    "title": "更新产品累计净值",
    "name": "updateProductAccumulationValues",
    "group": "Product",
    "version": "1.0.0",
    "parameter": {
      "fields": {
